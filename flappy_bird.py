import pygame, neat, os, time, random, pickle
...
class Bird:
    ...
    def jump(self):
        self.vel = -10.5  # as pygame 0,0 is on top left
        self.tick_count = 0
        self.height = self.y
...
def draw_window(win, birds, pipes, base, score, gen):
    ...
    times = STAT_FONT.render("Time:" + f"{round(ct - st, 1)}s", 1, (255, 255, 255))
    win.blit(times, (10, 40))
    ...
    while run:
        ...
        for x, bird in enumerate(birds):
            ...
            output = nets[x].activate(
                (bird.y, abs(bird.y - pipes[pipe_idx].height), abs(bird.y - pipes[pipe_idx].bottom)))
